...
public class translate {
     ...
     */
    public static void translate(String sourceText, PrintStream out) {
        Translate translate = createTranslateService();
    ...
    public static void main(String[] args) {
        ...
        if (command.equals("detect")) {
            ...
            try {
                ...
                translate.translateTextWithOptions(text, sourceLang, targetLang, System.out);
            } catch (ArrayIndexOutOfBoundsException ex) {
                translate.translate(text, System.out);
            }
        } else if (command.equals("langsupport")) {
            try {
                String target = args[1];
                translate.displaySupportedLanguages(System.out, Optional.of(target));
            } catch (ArrayIndexOutOfBoundsException ex) {
                translate.displaySupportedLanguages(System.out, Optional.<String>empty());
            }
        }
    }
}
